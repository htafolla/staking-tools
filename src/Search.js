          ...
          <Table className={self.props.classes.table} aria-label="simple table">
            <TableHead key="th">
              <TableRow key="tr">
                ...
                <TableCell className={self.props.classes.hideTableCell} key="b" align="right">Stake</TableCell>
                <TableCell key="pc" align="right">%Online</TableCell>
            ...
            <TableBody key="vb">
             {results.map((validator, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell className={self.props.classes.hideTableCell} key="{`${validator.stake}${index}`}" align="right">{utils.format.formatNearAmount(validator.stake, 0) + ' Ⓝ'}</TableCell>

...
exports.readBigUInt64LE = exports.decodeAccount = exports.decodeAccountHash = exports.deserializeData = exports.ACCOUNTHASH = exports.ACCOUNT = exports.SCHEMA = exports.AccountHash = exports.StakingContract = exports.AccountsMapValues = exports.AccountsMapKeys = exports.AccountsMap = exports.Account = exports.IAction = void 0;
const serialize_1 = require("../node_modules/near-api-js/src/utils/serialize");
const key_pair_1 = require("../node_modules/near-api-js/src/utils/key_pair");
const enums_1 = require("../node_modules/near-api-js/src/utils/enums");
var Big = require('big.js');
const sha256 = require('js-sha256').sha256;
class IAction extends enums_1.Assignable {
}
exports.IAction = IAction;
class RewardFeeFraction extends enums_1.Assignable {
}
class Account extends enums_1.Assignable {
}
exports.Account = Account;
class AccountsMap extends enums_1.Assignable {
}
exports.AccountsMap = AccountsMap;
class AccountsMapKeys extends enums_1.Assignable {
}
exports.AccountsMapKeys = AccountsMapKeys;
class AccountsMapValues extends enums_1.Assignable {
}
exports.AccountsMapValues = AccountsMapValues;
class StakingContract extends enums_1.Assignable {
}
exports.StakingContract = StakingContract;
class AccountHash extends enums_1.Assignable {
}
...
exports.SCHEMA = new Map([
    [
        StakingContract,
        {
            ...
            fields: [
                ['owner_id', 'string'],
                ['stake_public_key', key_pair_1.PublicKey],
...
function deserializeData(data) {
    ...
    let decerialized = serialize_1.deserialize(exports.SCHEMA, StakingContract, dataBuffer);
    let map = {};
    ...
    console.log(serialize_1.base_encode(decerialized.stake_public_key.key));
...
function decodeAccountHash(class_type, data) {
    return serialize_1.deserialize(exports.ACCOUNTHASH, class_type, Buffer.from(data, 'base64'));
}
exports.decodeAccountHash = decodeAccountHash;
function decodeAccount(class_type, data) {
    return serialize_1.deserialize(exports.ACCOUNT, class_type, Buffer.from(data, 'base64'));
}
